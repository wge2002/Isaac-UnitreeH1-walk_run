...
def main():
    ...
    env_cfg.commands.base_velocity.ranges.lin_vel_x = (1, 3)
    ...
    log_root_path = os.path.join("logs", "rsl_rl", "h1_run")
    log_root_path = os.path.abspath(log_root_path)
    print(f"[INFO] Loading experiment from directory: {log_root_path}")
    temporal_log = '/home/jojo/Documents/wge/H1_walk_my/logs/rsl_rl/h1_run/2025-04-30_16-54-33/model_999.pt'
    resume_path = get_checkpoint_path(log_root_path, agent_cfg.load_run, agent_cfg.load_checkpoint)
    resume_path = temporal_log
